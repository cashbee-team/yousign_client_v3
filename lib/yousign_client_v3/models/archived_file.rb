...
module YousignClientV3
  ...
  class ArchivedFile
    ...
    def list_invalid_properties
      ...
      if @sha256.to_s.length > 64
        invalid_properties.push('invalid value for "sha256", the character length must be smaller than or equal to 64.')
      end

      if @sha256.to_s.length < 64
        invalid_properties.push('invalid value for "sha256", the character length must be great than or equal to 64.')
      end
    ...
    def valid?
      ...
      return false if @sha256.to_s.length > 64
      return false if @sha256.to_s.length < 64
      ...
      return false if @workspace_id.to_s.length < 1
      true
    end
    ...
    def sha256=(sha256)
      ...
      if sha256.to_s.length > 64
        fail ArgumentError, 'invalid value for "sha256", the character length must be smaller than or equal to 64.'
      end

      if sha256.to_s.length < 64
        fail ArgumentError, 'invalid value for "sha256", the character length must be great than or equal to 64.'
      end
