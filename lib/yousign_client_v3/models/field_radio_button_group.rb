  ...
  class FieldRadioButtonGroup
    ...
    def self.openapi_types
      {
        ...
        :'optional' => :'Boolean',
        :'name' => :'String',
        :'radios' => :'Array<FieldRadioButtonGroupRadiosInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `YousignClientV3::FieldRadioButtonGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `YousignClientV3::FieldRadioButtonGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @radios.nil?
        invalid_properties.push('invalid value for "radios", radios cannot be nil.')
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["radio_group"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["radio_group"])
    ...
    def hash
      [id, document_id, signer_id, type, page, optional, name, radios].hash
    end
