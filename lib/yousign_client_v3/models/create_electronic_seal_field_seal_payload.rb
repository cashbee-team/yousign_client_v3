...
module YousignClientV3
  class CreateElectronicSealFieldSealPayload
    attr_accessor :type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `YousignClientV3::CreateElectronicSealFieldSealPayload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `YousignClientV3::CreateElectronicSealFieldSealPayload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @height > 32767
        invalid_properties.push('invalid value for "height", must be smaller than or equal to 32767.')
      end
      ...
      if @page > 32767
        invalid_properties.push('invalid value for "page", must be smaller than or equal to 32767.')
      end
      ...
      if !@reason.nil? && @reason.to_s.length > 200
        invalid_properties.push('invalid value for "reason", the character length must be smaller than or equal to 200.')
      end

      pattern = Regexp.new(/^(?!\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\'()\- ]+(?<!\s)$/)
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["seal", "read_only_text"])
      return false unless type_validator.valid?(@type)
      return false if @height.nil?
      return false if @height > 32767
      return false if @height < 1
      return false if @width.nil?
      return false if @width > 32767
      return false if @width < 1
      return false if @page.nil?
      return false if @page > 32767
      ...
      return false if @y < 0
      return false if !@reason.nil? && @reason.to_s.length > 200
      return false if !@reason.nil? && @reason !~ Regexp.new(/^(?!\s)[0-9A-Za-zĄÀÁÂÃÄÅÇĆÈÉÊËĘÌÍÎÏŁÑŃÒÓÔÕÖŚÙÚÛÜÝŹŻąàáâãäåæçćèéêëęìíîïłñńòóôõöśùúûüýÿźżß`\'()\- ]+(?<!\s)$/)
      true
    end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["seal", "read_only_text"])
    ...
    def height=(height)
      ...
      if height > 32767
        fail ArgumentError, 'invalid value for "height", must be smaller than or equal to 32767.'
      end
    ...
    def width=(width)
      ...
      if width > 32767
        fail ArgumentError, 'invalid value for "width", must be smaller than or equal to 32767.'
      end
    ...
    def page=(page)
      ...
      if page > 32767
        fail ArgumentError, 'invalid value for "page", must be smaller than or equal to 32767.'
      end
    ...
    def reason=(reason)
      if !reason.nil? && reason.to_s.length > 200
        fail ArgumentError, 'invalid value for "reason", the character length must be smaller than or equal to 200.'
      end
    ...
    def hash
      [type, height, width, page, x, y, reason].hash
    end
